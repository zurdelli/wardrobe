...
import 'package:wardrobe/widgets/categories_widget.dart';
import 'package:wardrobe/widgets/clothes_widget.dart';
...
class MyWardrobeState extends State<MyWardrobe> {
  ...
  Widget _getMyWardrobe2() {
    return Expanded(
      child: Column(
        children: [
          Text(
              "${Provider.of<CategoryProvider>(context, listen: false).currentCategory} en ${Provider.of<LocationProvider>(context, listen: false).currentLocation}"),
          SizedBox(
            height: 15,
          ),
          Expanded(
